        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrentPositionsFilled = table.Column<int>(type: "int", nullable: false),
                    TotalPositionsNeeded = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FireUrlBase = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FileUrlSigned = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    NationalStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),

...
namespace HRM.Data.Migrations
{
    ...
    [Migration("20240908171537_InitalCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.Data.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRM.Data.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRM.Data.Entities.Applicants", b =>
                {
                    b.HasOne("HRM.Data.Entities.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HRM.Data.Entities.Contract", b =>
                {
                    ...
                    b.HasOne("HRM.Data.Entities.ContractType", null)
                        .WithMany("Contracts")
            ...
            modelBuilder.Entity("HRM.Data.Entities.ContractAllowance", b =>
                {
                    b.HasOne("HRM.Data.Entities.Allowance", null)
            ...
            modelBuilder.Entity("HRM.Data.Entities.ContractInsurance", b =>
                {
                    ...
                    b.HasOne("HRM.Data.Entities.Insurance", null)
            ...
            modelBuilder.Entity("HRM.Data.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("HRM.Data.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM.Data.Entities.History", b =>
                {
                    b.HasOne("HRM.Data.Entities.Payroll", "Payroll")
                        .WithMany("History")
                        .HasForeignKey("PayrollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HRM.Data.Entities.Payroll", b =>
                {
                    ...
                    b.HasOne("HRM.Data.Entities.TaxRate", "TaxRate")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM.Data.Entities.User", b =>
                {
                    b.HasOne("HRM.Data.Entities.Role", "Role")
                        .WithMany()
